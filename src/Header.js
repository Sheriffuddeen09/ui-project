    ...
    return(
        ...
        <nav>
          <div className="flexnav">
            ...
            <ul className="uls">
                <li  className={`'background' ${homepage === '/home' ? 'primary' : 'background'}`}><Link  to='/home' className='butto '><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className='icon'  style={{translate:'-12px'}}>
